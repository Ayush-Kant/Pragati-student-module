...
const NotFoundPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-[#0b0f19] text-center px-4 transition-colors duration-200">
      <ThemeToggle variant="floating" />
      <h1 className="text-8xl font-black text-gray-200 dark:text-gray-800">404</h1>
      <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mt-4">Page not found</h2>

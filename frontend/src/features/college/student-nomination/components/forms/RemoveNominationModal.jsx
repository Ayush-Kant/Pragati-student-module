      ...
      <div className="space-y-8 p-8">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              >
                Removing this nomination will immediately remove the student
                from the active nomination list.
              </p>
              ...
              >
                ...
                <li>
                  The student's status will become <strong>Eligible</strong>.
                </li>

                <li>The student can be nominated again in the future.</li>

                <li>
                  This action should only be used for incorrect or cancelled
                  nominations.
                </li>
              </ul>
            </div>
        ...
        <div>
          <label className="mb-2 block text-sm font-medium">
            Removal Reason <span className="text-slate-500">(Optional)</span>
          </label>
          ...
          <textarea
            ...
            placeholder="Example: Student opted out, duplicate nomination, company withdrew the opportunity..."
        ...
        <div>
          <label className="mb-2 block text-sm font-medium">
            Type <span className="font-bold text-red-500">REMOVE</span> exactly
            as shown to continue.
          </label>
          ...
          >
            The Remove button will be enabled only after typing{" "}

...
import { Eye, Pencil, Trash2, RotateCcw, CircleUserRound, BadgeCheck, HelpCircle, Loader2 } from "lucide-react";
...
const NominatedTable = ({
  ...
  const fullGrid = "grid grid-cols-[2.2fr_1.1fr_1.8fr_1.4fr_1.1fr_1.4fr_2.2fr]";

  ...
  return (
    <div className="flex flex-col gap-6">
              ...
              {isExpanded && (
                ...
                >
                  <div className="relative">
                    ...
                    <div className="overflow-hidden w-full max-w-full xl:max-w-[1000px]">
                      {/* ==========================
                              SCROLL AREA
                        ========================== */}
      ...
      {companyGroups.length === 0 && (
        <div
          className={`flex h-72 flex-col items-center justify-center rounded-3xl border ${
            darkMode
              ? "border-slate-700 bg-[#151D30]"
              : "border-slate-200 bg-white"
          }`}
        >
          ...
          >
            No shortlisted students match your current search or selected
            company.
          </p>
        </div>
      )}

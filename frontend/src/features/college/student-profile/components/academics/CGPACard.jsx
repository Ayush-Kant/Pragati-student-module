...
export const CGPACard = ({ cgpa = 0.0, semestersCompleted = 0 }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex items-center justify-between gap-4">
      <div className="space-y-2">
        <div className="flex items-center gap-2 text-indigo-600">
          <Award className="w-5 h-5" />
          <span className="text-xs font-bold uppercase tracking-wider">Overall Standing</span>
        </div>
        <h3 className="text-2xl font-black text-gray-900">Cumulative GPA</h3>
      ...
      <div className="relative w-24 h-24 flex items-center justify-center flex-shrink-0">
        ...
        <div className="absolute text-center">
          <span className="block text-xl font-black text-indigo-600 leading-tight">

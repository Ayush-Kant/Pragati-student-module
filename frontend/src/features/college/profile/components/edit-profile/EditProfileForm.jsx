  ...
  return (
    <div className="min-h-screen p-6 font-sans">
      <div className="max-w-5xl">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Edit College Profile</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-8 mb-6">
            {/* Logo Section */}
            <div>
              <label className="text-sm font-semibold text-gray-900 block mb-4">College Logo</label>
              <div className="flex flex-col items-center md:items-start">
                ...
                <p className="text-xs text-gray-500 mt-4 text-center md:text-left">JPG, PNG or GIF. Max size 2MB.</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 mt-2 items-start">
            <ProfileTextarea
              label="Address"
              name="address"
          ...
          <div className="flex justify-end gap-4 mt-8 pt-6">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 bg-[#f97316] hover:bg-[#ea580c] text-white font-semibold rounded-lg transition-colors"
            >
              Save Changes
            </button>
          </div>

// src/features/student/placement/components/assessments/TechnicalScore.jsx
// Displays Technical & Coding assessment metrics with sub-topic breakdowns.

import React from 'react';
import { Terminal, Calendar, RotateCcw } from 'lucide-react';
import { getScoreColorClass } from '../../utils/placementHelpers';

export default function TechnicalScore({ category }) {
    ...
    <div className="card shadow-card hover:shadow-card-md transition-shadow">
      <div className="flex items-start justify-between pb-3 mb-3 border-b border-surface-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="section-title text-base">{label} Assessment</h3>
            <p className="text-xs text-surface-500">Core CS, DSA, and problem solving</p>
          </div>
        </div>

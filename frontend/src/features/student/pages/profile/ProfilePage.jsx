                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input
                                        type="url"
                                        defaultValue={profile.portfolioLinks.github}
                                ...
                                <div>
                                    ...
                                    <input type="url" defaultValue={profile.portfolioLinks.linkedin} onChange={(e) => handleLinkChange('linkedin', e.target.value)} className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50/50 font-semibold text-gray-700" />
                                </div>
                                <div>
                                    <label className="block text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-1">Personal Website</label>
                                    <input type="url" defaultValue={profile.portfolioLinks.website} onChange={(e) => handleLinkChange('website', e.target.value)} className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50/50 font-semibold text-gray-700" />
                                </div>
                            </div>
                        </div>

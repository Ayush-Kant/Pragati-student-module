...
export const getMentors = async () => {
  const response = await API.get("/mentors", getConfig());
  return response.data;
};

// Get mentor details
export const getMentorById = async (mentorId) => {
  const response = await API.get(`/mentors/${mentorId}`, getConfig());
  return response.data;
};
...
export const registerMentor = async (mentorData) => {
  const response = await API.post("/mentors", mentorData, getConfig());
  return response.data;
};

// Assign mentor to batch
export const assignMentor = async (mentorId, assignData) => {
...
// Replace mentor
export const replaceMentor = async (mentorId, replaceData) => {
  const response = await API.patch(
...
export const removeMentor = async (mentorId) => {
  const response = await API.delete(`/mentors/${mentorId}`, getConfig());
  return response.data;
};

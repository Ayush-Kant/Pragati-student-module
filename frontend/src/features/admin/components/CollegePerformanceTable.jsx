const CollegePerformanceTable = ({ colleges, darkMode }) => {
    ...
    if (sortedColleges.length === 0) {
        return (
            <div
                className={`
                    flex items-center justify-center h-40 text-sm
                    ${
                        darkMode
                            ? "text-gray-400"
                            : "text-gray-500"
            ...
            <table className="min-w-full border-collapse">
                ...
                <thead>
                    ...
                    >
                        ...
                        <th
                            className={`
                                text-left py-3 px-4 text-sm font-semibold min-w-[180px]
                                ${
                                    darkMode
                                        ? "text-gray-300"
                                        : "text-gray-700"
                ...
                <tbody>
                    {sortedColleges.map((college, index) => {
                        ...
                        const progressColor =
                            getProgressColor(selectionRate);
                            ...
                            <tr
                                ...
                                className={`
                                    ...
                                    ${
                                        isTopRank
                                            ? darkMode
                                                ? "border-l-4 border-l-yellow-500 bg-yellow-900/10"

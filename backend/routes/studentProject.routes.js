...
import { deleteFile, uploadFile, uploadProjectFile, uploadProjectReport } from '../controllers/studentProjectFile.controller.js';
...
router.post('/:projectId/submit', uploadProjectReport, submitProject);
